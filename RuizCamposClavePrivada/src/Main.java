...
public class Main {
    ...
    public static final String PEDIR_NOMARCHIVO = "Escribe el nombre del fichero donde esta la clave del modo de encriptar";
   ...
   //C:\Users\GL512\IdeaProjects\AguilarJimenezClavePrivada\src\Claves\
    public static final String RUTA_CLAVES = ".\\";
